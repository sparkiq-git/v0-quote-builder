    ...
    return (
      <div className="flex flex-col gap-2 w-full">
        ...
        <Input
          ...
          className="h-11 bg-background/40 backdrop-blur-md border-border/30 hover:bg-background/60 hover:border-border/50 appearance-none [&::-webkit-calendar-picker-indicator]:hidden [&::-webkit-calendar-picker-indicator]:appearance-none [&::-webkit-datetime-edit-hour-field]:bg-black [&::-webkit-datetime-edit-hour-field]:text-white [&::-webkit-datetime-edit-hour-field]:px-1 [&::-webkit-datetime-edit-hour-field]:rounded [&::-webkit-datetime-edit-minute-field]:bg-black [&::-webkit-datetime-edit-minute-field]:text-white [&::-webkit-datetime-edit-minute-field]:px-1 [&::-webkit-datetime-edit-minute-field]:rounded [&::-webkit-datetime-edit-ampm-field]:bg-black [&::-webkit-datetime-edit-ampm-field]:text-white [&::-webkit-datetime-edit-ampm-field]:px-1 [&::-webkit-datetime-edit-ampm-field]:rounded"
        />
      </div>
    )
  }
    ...
    <div className="flex gap-4 w-full">
      ...
      <div className="flex flex-col gap-2 flex-1">
        ...
        <Input
          ...
          value={time || ""}
          onChange={(e) => onTimeChange?.(e.target.value)}
          className="bg-background/40 backdrop-blur-md border-border/30 hover:bg-background/60 hover:border-border/50 appearance-none [&::-webkit-calendar-picker-indicator]:hidden [&::-webkit-calendar-picker-indicator]:appearance-none [&::-webkit-datetime-edit-hour-field]:bg-black [&::-webkit-datetime-edit-hour-field]:text-white [&::-webkit-datetime-edit-hour-field]:px-1 [&::-webkit-datetime-edit-hour-field]:rounded [&::-webkit-datetime-edit-minute-field]:bg-black [&::-webkit-datetime-edit-minute-field]:text-white [&::-webkit-datetime-edit-minute-field]:px-1 [&::-webkit-datetime-edit-minute-field]:rounded [&::-webkit-datetime-edit-ampm-field]:bg-black [&::-webkit-datetime-edit-ampm-field]:text-white [&::-webkit-datetime-edit-ampm-field]:px-1 [&::-webkit-datetime-edit-ampm-field]:rounded"
        />
      </div>
    </div>
  )
