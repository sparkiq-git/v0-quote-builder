...
interface CreateUserModalSimpleProps {
  open: boolean
...
export function CreateUserModalSimple({ open, onOpenChange, onSuccess }: CreateUserModalSimpleProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Create New User (Simple Test)</DialogTitle>
          <DialogDescription>
            Simplified form to test input error
          </DialogDescription>
        </DialogHeader>
