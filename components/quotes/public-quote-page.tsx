...
export default function PublicQuotePage({ params, onAccept, onDecline, verifiedEmail, quote }: PublicQuotePageProps) {
  ...
  // Helper function to call trip_notifications edge function
  const callTripNotifications = async (
    ...
    try {
      ...
      if (!anonKey || !supabaseUrl) {
        console.warn("Missing Supabase environment variables for trip_notifications")
        return
      }
      ...
      if (!res.ok) {
        console.error("trip_notifications edge function error:", json)
